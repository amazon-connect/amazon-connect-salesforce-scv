({
    ...
    doInit : function(cmp, event, helper) {
        ...
        const amazonConnectInstanceName = cmp.get('v.amazonConnectInstanceName')

        cmp.set('v.utilityBarHelperFrameSrc', `/apex/UtilityBarHelper?amazonConnectInstanceName=${amazonConnectInstanceName}`);
